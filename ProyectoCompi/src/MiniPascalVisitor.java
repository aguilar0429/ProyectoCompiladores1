...
public interface MiniPascalVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MiniPascalParser#math_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMath_expr(MiniPascalParser.Math_exprContext ctx);
	/**
	 * Visit a parse tree produced by {@link MiniPascalParser#bool_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBool_expr(MiniPascalParser.Bool_exprContext ctx);
	/**
